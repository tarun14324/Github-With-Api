...
import com.tarun.myapplication.room.RemoteKeys
...
class UserRemoteMediatore(
    ...
    override suspend fun load(loadType: LoadType, state: PagingState<Int, Item>): MediatorResult {
        ...
        try {
            val apiResponse = service.getRepo(apiQuery, page, state.config.pageSize)
            ...
            repoDatabase.withTransaction {
                ...
                repoDatabase.userDao().insertAll(repos)
            }
